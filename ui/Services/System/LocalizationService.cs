...
namespace Odzen.Avalonia.Services
{
    ...
    public static class LocalizationService
    {
        ...
        private static readonly Dictionary<string, (string TR, string EN)> _strings = new()
        {
            ...
            { "AppSettingsSubtitle", ("ODZEN sistem tercihlerini, dil ve arayüz ölçeklendirmesini yapılandırın.", "Configure ODZEN system preferences, language, and UI scaling.") },
            ...
            { "AiEngine", ("Akıllı Arka Plan Oyun Algılama", "Smart Background Game Detection") },
            { "AiDetection", ("Akıllı Oyun Tespiti", "Smart Game Detection") },
            { "Back", ("Geri Dön", "Back") },
